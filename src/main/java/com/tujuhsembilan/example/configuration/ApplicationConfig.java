    ...
    http
        ...
        .authorizeHttpRequests(req -> req
            ...
            .requestMatchers(AntPathRequestMatcher.antMatcher("/auth/login")).permitAll()
                .requestMatchers(AntPathRequestMatcher.antMatcher("/admin/*")).hasAuthority("SCOPE_ADMIN")
                .requestMatchers(AntPathRequestMatcher.antMatcher("/note")).hasAuthority("SCOPE_ROLE_A")
                .requestMatchers(AntPathRequestMatcher.antMatcher("/note")).hasAuthority("SCOPE_ROLE_B")
